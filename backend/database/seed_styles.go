	...
	entries := []models.StyleLibrary{
		{
			...
			Name:          "浅蓝通栏",
			LayoutID:      "skyveil",
			Categories:    marshalJSON([]string{"互联网通用", "前端开发", "校招", "实习"}),
		...
		},
		{
			...
			Name:          "青蓝圆标",
			LayoutID:      "cyanblu",
			Categories:    marshalJSON([]string{"互联网通用", "后端开发", "Golang", "社招"}),
		...
		},
		{
			...
			Name:          "黑白简线",
			LayoutID:      "ordrin",
			Categories:    marshalJSON([]string{"后端开发", "Golang", "Java", "C++", "社招"}),
		...
		},
		{
			...
			Name:          "居中单栏",
			LayoutID:      "centerline",
			Categories:    marshalJSON([]string{"互联网通用", "校招", "实习"}),
		...
		},
		{
			...
			Categories:    marshalJSON([]string{"后端开发", "Java", "C++", "社招"}),
		...
		},
		{
			...
			Categories:    marshalJSON([]string{"后端开发", "Java", "社招"}),
