          ...
          <>
            ...
            >
              <button
                ...
                className="group/menu flex h-10 w-full items-center gap-2.5 rounded-[10px] px-3 text-[13px] font-medium text-slate-700 transition-colors hover:bg-[var(--theme-accent-soft)] dark:text-slate-200"
              >
                ...
                return (
                  <>
                    ...
                    <button
                      ...
                      className="group/menu flex h-10 w-full items-center gap-2.5 rounded-[10px] px-3 text-[13px] font-medium text-blue-500 transition-colors hover:bg-[var(--theme-accent-soft)] dark:text-blue-400"
                    >
