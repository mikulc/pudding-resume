    ...
    <>
        ...
        <div className="settings-card rounded-[20px] border border-slate-200/70 bg-white p-4 shadow-[0_3px_12px_rgba(15,23,42,0.035)] dark:border-white/[0.07] dark:bg-slate-800/90 dark:shadow-none">
          ...
          <button
            ...
            className="group flex w-full items-center gap-3 rounded-[14px] border border-slate-200/70 bg-slate-50/90 p-3 text-left transition-colors hover:border-[var(--theme-accent)] hover:bg-[var(--theme-accent-soft)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--theme-accent)] dark:border-white/[0.07] dark:bg-white/[0.035] dark:hover:border-[var(--theme-accent)] dark:hover:bg-[var(--theme-accent-soft)]"
          >
            ...
            <span className="shrink-0 rounded-full bg-[var(--theme-accent-soft)] px-2 py-[3px] text-[11px] font-medium leading-4 text-[var(--theme-accent)]">
          ...
          <div className="mt-3 flex gap-2">
            <button
              type="button"
              onClick={() => setThemeDrawerOpen(true)}
              className="inline-flex h-10 min-w-0 flex-1 items-center justify-center gap-1.5 rounded-[11px] bg-[var(--theme-accent-soft)] px-3 text-[13px] font-medium text-[var(--theme-accent)] transition-opacity hover:opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--theme-accent)]"
            >
