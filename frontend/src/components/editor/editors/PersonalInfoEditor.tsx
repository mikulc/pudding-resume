      ...
      <div className="bg-white rounded-[22px] shadow-sm border border-gray-100 p-2.5 min-w-0">
        ...
        <div className="grid min-w-0 grid-cols-[88px_minmax(0,1fr)] items-start gap-2.5">
          ...
          <div className="flex min-w-0 flex-col gap-1.5 pt-1">
            ...
            {personalInfo.photoUrl && (
              <div className="flex w-full min-w-0 max-w-full flex-nowrap items-center gap-0.5 overflow-hidden">
                <button
                  ...
                  className="min-w-0 truncate px-1.5 py-1.5 text-xs text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
                >
                  {t('photo.adjust')}
                </button>
                <button
                  ...
                  className="min-w-0 shrink-0 truncate px-1.5 py-1.5 text-xs text-red-500 hover:bg-red-50 rounded-lg transition-colors"
                >
